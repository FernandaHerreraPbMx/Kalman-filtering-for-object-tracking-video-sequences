...
int main(int argc, char ** argv) {
    ...
    for(int n_video=0; n_video < num_videos; n_video = n_video+1){
        ...
        for(;;){
            ...
            circle(results, tracker.measPt,8,CV_RGB(100,100,255),2);
            circle(results, tracker.statePt,4,CV_RGB(255,0,0),2);
            ...
            printAllResults(results_all, estimations,  CV_RGB(255,0,0),1,2);
            
            putText(results, "Predictions", Point(10, 50), 1, 1, CV_RGB(0,255,0), 3);
            putText(results_all, "Predictions", Point(10, 50), 1, 1, CV_RGB(0,255,0), 3);
            putText(results, "Measurements", Point(10, 100), 1, 1, CV_RGB(100,100,255), 3);
            putText(results_all, "Measurements", Point(10, 100), 1, 1, CV_RGB(100,100,255), 3);
            putText(results, "Estimations", Point(10, 150), 1, 1, CV_RGB(255,0,0), 3);
            putText(results_all, "Estimations", Point(10, 150), 1, 1, CV_RGB(255,0,0), 3);
